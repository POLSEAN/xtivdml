...
#' `xtivdml_data` sets up the data environment for panel data analysis with transformed variables.
#' The [xtivdml_data_from_data_frame()] function can be used to create a new
#' instance of `xtivdml_data` from a `data.frame`.
#' @export
xtivdml_data = R6Class("xtivdml_data",
                              active = list(
                              ...
                              public = list(
                                ...
                                print = function() {
                                  ...
                                  data_info = paste0(
                                    ...
                                    "No. Groups: ", length(unique(self$data_model[[self$cluster_cols]])), "\n")
...
#'
#' @description
#' Initalization of xtivdml_data from `data.frame`.
#'
...
#'
#' @return Creates a new instance of class `xtivdml_data`.
#'
#' @examples
#' # Generate simulated panel dataset from `xtivdml`
#' data = make_plpr_data(n_obs = 500, t_per = 10, dim_x = 30, theta = 0.5, pi = 0.8,
#'                     sigma_ur = 0.6, rho=0.8)
#'
#' # Set up DML data environment
#' x_cols  = paste0("X", 1:30)
#'
#' obj_xtivdml_data = xtivdml_data_from_data_frame(data,
#'                 x_cols = x_cols,  y_col = "y",
#'                 d_cols = "d", z_cols = "z",
#'                 cluster_cols = "id")
#' obj_xtivdml_data$print()
#'
#' @export
xtivdml_data_from_data_frame = function(df,
